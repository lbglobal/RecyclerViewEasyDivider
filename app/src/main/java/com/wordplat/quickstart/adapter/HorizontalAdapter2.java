...
public class HorizontalAdapter2 extends RecyclerView.Adapter<HorizontalViewHolder> {
    ...
    public HorizontalAdapter2(Activity activity) {
        mActivity = activity;
    }

    @Override
    public HorizontalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mActivity).inflate(R.layout.item_image_horizontal2, parent, false);
